...
if __name__ == "__main__":
    ...
    argparser.add_argument("--catalog", type=str, default="coffee_machines", choices=["election_articles","election_articles_named", "coffee_machines", "books", "cameras"], help="The product catalog to use.")
